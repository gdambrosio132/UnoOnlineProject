 ...
 * Objects.Texture objects are typically created using the {@link #load(String)} method.
 * Multiple instances of a Sprite may share a single Objects.Texture reference.
 *
 */
public class Texture
{
    ...
    /**
     * Create a Objects.Texture from the image file with the given file name.
     * Sets {@link #region} to the original image dimensions.
     * @param imageFileName name of the image file
     * @return A Objects.Texture object that displays the image file with the given file name.
     */
